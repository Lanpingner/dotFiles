...
export default monitor => Widget.Window({
    ...
    monitor,
    binds: [['anchor', options.topbar.position, 'value', pos => ([
        pos, 'left', 'right',
    ])]],
